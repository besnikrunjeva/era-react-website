...
const copy = {
  al: {
    badge:       'Kontakto ERA',
    h1:          'Kërko ofertën tënde falas',
    sub:         'Dërgo logon tënde dhe specifikimet — brenda 24 orësh merr ofertën falas.',
    ...
    formSub:     'Plotëso formularin — brenda 24 orësh jemi tek ti.',
    name:        'Emri & Mbiemri *',
    biz:         'Emri i Biznesit',
    emailF:      'Email Adresa *',
    ...
    msg:         'Mesazhi yt *',
    msgPh:       'Përshkruaj produktin që të nevojitet, sasinë e përafërt dhe afatin...',
    submit:      'Dërgo Mesazhin',
    sending:     'Duke dërguar...',
    successT:    'Mesazhi u dërgua!',
    successS:    'Do të të kontaktojmë brenda 24 orësh. Mund të na kontaktosh edhe direkt në WhatsApp.',
    errorT:      'Ndodhi një gabim',
    errorS:      'Provo përsëri ose na kontakto direkt në WhatsApp.',
